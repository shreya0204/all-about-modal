...
const initPlugin = (pluginInfo) => {
	const chunksToReplace = {
		...
		"easy-wp-modal": pluginInfo.kebabCase,
		"Project-Name": pluginInfo.trainCase,
		"PROJECT-NAME": pluginInfo.cobolCase,
		easy_wp_modal: pluginInfo.snakeCase,
		Easy_WP_Modal: pluginInfo.pascalSnakeCase,
		EASY_WP_MODAL: pluginInfo.macroCase,
		"easy-wp-modal-": pluginInfo.kebabCaseWithHyphenSuffix,
		"Project-Name-": pluginInfo.trainCaseWithHyphenSuffix,
		"PROJECT-NAME-": pluginInfo.cobolCaseWithHyphenSuffix,
		easy_wp_modal_: pluginInfo.snakeCaseWithUnderscoreSuffix,
		Easy_WP_Modal_: pluginInfo.pascalSnakeCaseWithUnderscoreSuffix,
		EASY_WP_MODAL_: pluginInfo.macroCaseWithUnderscoreSuffix,
	};
